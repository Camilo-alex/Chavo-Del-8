...
/**
 * Controlador del proyecto ChavoDel8.
...
public class ControladorInteraccion implements IControlador {
    ...
    // HashMap para guardar los personajes
    ...
    // Llena el HashMap y los ComboBox
    ...
    private String obtenerFrase(String quien, String conQuien) {
        try {
            ...
            Personaje p2 = personajes.get(conQuien);
                    ...
                    //instanceof = sirve para verificar si un objeto pertenece a una clase específica o a una clase hija.
                    //devuelve true si el obejto si es de la clase sino == flase
            if (p1 instanceof Chavo) {
                Chavo c = (Chavo) p1;
                return c.pedirTorta();
